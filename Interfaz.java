...
public class Interfaz {
	...
	new PlanificadorCorto(t,1,disco,cajaCorto,cpu,cola_CPU1,retardo,listosIO1,nprocesos,muertos);
	new PlanificadorCorto(t,2,disco,cajaCorto,cpu,cola_CPU2,retardo,listosIO1,nprocesos,muertos);
